...
export const NavBar = () => {
    ...
    return (
        <>
            <nav class="fixed top-0 z-50 w-full bg-custom-black">
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center justify-start rtl:justify-end">
                            ...
                            <div class="flex ms-2 md:me-24">
                                <img src={planeLogo} class="h-8 me-3" alt="Logo de avion" />
                                <span class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">Icesi viajes</span>
                            </div>
                        </div>
