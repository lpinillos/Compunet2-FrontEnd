            ...
            <div className="ml-64 p-4">
                ...
                <div className="flex flex-wrap justify-center mt-5">
                    {Array.isArray(users) && users.length > 0 ? (
                        filterData.map(user => (
                            <div key={user.id_user} className="lg:w-1/4 md:w-1/2 p-4 w-full">
                                <div
                                    ...
                                    style={{ height: '380px' }}
                                    onClick={() => navigate('/InfoViewerView', { state: { viewerObj: user } })}
                                >
                                    <div className="relative h-48 w-full">
                                        <img alt={user.id_user} className="object-cover object-center w-full h-full"/>
                                    </div>
                                    <div className="p-4 bg-white">
                                        <h3 className="text-gray-600 font-semibold text-sm mb-1">Viewer</h3>
                        ...
                        <p className="text-center text-gray-600 mt-8">No hay Viewers disponibles</p>
                    )}
                </div>
            </div>
        </>
