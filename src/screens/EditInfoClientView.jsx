                ...
                <div className="ml-64 p-4">
                    <div className="lg:w-4/5 mt-28 ml-28 flex flex-wrap shadow-md border border-gray-800 border-x-2 border-y-2 hover:shadow-xl rounded-lg">
                        ...
                        <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                            ...
                            <textarea className="leading-relaxed mr-2 mb-1 border border-gray-800" value={clientObj.mail}></textarea>
                            <input type="text" className="leading-relaxedmr-2 mb-1 border border-gray-800" value={clientObj.phone}></input>
                            <input type="text" className="leading-relaxed mr-2 mb-1 border border-gray-800" value={clientObj.Gender}></input>
                            <input type="text" className="leading-relaxed mr-2 mb-10 border border-gray-800" value={clientObj.birthdate}></input>
                            <div className="flex">
                                ...
                                <button className="flex mx-10 text-white bg-custom-orange border-0 py-2 px-6 focus:outline-none hover:bg-hover-orange rounded" onClick={() => navigate('/InfoClientView', { state: { clientObj: clientObj } })}>Volver</button>
                            </div>
                        </div>
                    </div>
                </div>
