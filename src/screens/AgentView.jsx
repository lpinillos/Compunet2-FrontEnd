        ...
        <>
            ...
            <div className="ml-64 p-4">
                <div className="flex justify-end w-full">
                    ...
                    &nbsp;&nbsp;&nbsp;
                    <Link to='/CreatePlan'>
                        <button className='bg-custom-orange hover:bg-hover-orange rounded-lg w-32 h-11 font-semibold text-white mt-5 mr-28'>Anadir Agente</button>
                    </Link>
                </div>
                        ...
                        agents.map(user => (
                            <div key={user.id_user} className="lg:w-1/4 md:w-1/2 p-4 w-full rounded-lg shadow-md border border-gray-800 border-x-2 border-y-2 hover:shadow-xl mx-10 mb-8">
                                ...
                                <div className="mt-4">
                                    ...
                                    <h2 className="text-black title-font text-lg font-medium hover:text-hover-orange" onClick={() => navigate('/InfoAgentView', { state: {userObj: user}})}>
                                        {user.login}
                                    </h2>
