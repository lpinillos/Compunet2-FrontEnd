    ...
    return (
        <>
            ...
            <section class="text-gray-400 bg-gray-900 body-font min-h-screen">
                <div class="ml-64 p-4 mt-[56px]">
                    <div class="lg:w-4/5 mt-28 ml-28 flex flex-wrap shadow-md border border-gray-800 hover:shadow-xl">
                        ...
                        <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                            <h2 class="text-sm title-font text-white tracking-widest font-semibold">Tokio - Japón</h2>
                            <h1 class="text-white text-3xl title-font font-medium mb-1">Plan Mochilero</h1>
                            <div class="flex mb-4">
