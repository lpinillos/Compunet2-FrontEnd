                    ...
                    <div className="lg:w-4/5 mt-28 mx-auto flex flex-wrap shadow-md border border-gray-300 hover:shadow-lg rounded-lg overflow-hidden">
                        ...
                        <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                            ...
                            <div className="flex flex-col mb-4">
                                <p className="ltext-gray-700 mb-2"><span className="font-semibold">Número de personas:</span> {planObj.num_people}</p>
                                <p className="ltext-gray-700 mb-2"><span className="font-semibold">Fecha de inicio:</span> {formatDate(planObj.start_Date)}</p>
                                <p className="ltext-gray-700 mb-2"><span className="font-semibold">Fecha de finalización:</span> {formatDate(planObj.end_Date)}</p>
                                <p className="ltext-gray-700 mb-2"><span className="font-semibold">Estado:</span> {planObj.state}</p>
                            </div>
